  ...
  return (
    <>
        ...
        <div className="productbg overflow-hidden pb-5">
          ...
          <div className="container">
            {items.map((elem) => {
              const { image, heading } = elem;
              return (
                <div className=" mb-5  row"data-aos="fade-up"
                data-aos-duration="3000">
                  <div className="col-4 center-vertical"data-aos="fade-right"data-aos-easing="linear"data-aos-delay="1500"
     data-aos-duration="1500">                 
                  ...
                  <div className="col-4 center-vertical"data-aos="fade-left"data-aos-easing="linear"data-aos-delay="1500"
     data-aos-duration="1500">                  
                    <img
                  ...
                  <div className="center-vertical"><button className=" mt-sm-5 btn_text d-flex productTitle">
                    {heading}
                  </button></div>
