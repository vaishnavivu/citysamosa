      ...
      <div className="row mt-3">
        ...
        >
          ...
          <div className="row usp_card">
            ...
            <h5>
              Our menu has varieties of most loved food items and beverages that
              satiate both taste and appetite
            </h5>
          </div>{" "}
          <div className="row usp_card">
        ...
        >
          <div className="row usp_card">
            ...
            <h5>
              Everyone loves chai and thus everyone should be able to afford our
              Kulhad chai.
            </h5>
          </div>{" "}
          <div className="row usp_card">
            <h4>Eco-Friendly</h4>
            <h5>
              We serve our beverages in kulhads which are much more eco-friendly
              than plastics or other alternatives.
            </h5>
          </div>{" "}
          <div className="row usp_card">
            <h4>No-Smoking</h4>
            <h5>
              We want people especially the youth to enjoy eco-friendly ‘Kulhad
              Chai Breaks’ rather than ‘Sutta Breaks’.
            </h5>
          </div>
        </div>
      </div>
