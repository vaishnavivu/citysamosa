...
function Tophead() {
  ...
  return (
      ...
      >
        ...
        <div className="container firstnav pt-2 pb-2">
          ...
          <div>
            ...
            <a className="navbar-brand pl-5 ml-5" href="callto:7304454574">
              +91 7304454574
            </a>
          </div>
	...
	d-md-block d-lg-none"
          ...
          <img className='tophead_img1 mbhidden'alt="" src="../City Samosa1.png"></img> 
	...
	d-md-none d-lg-block" id="logo">
                <Link className="active navbar-brand logo ml-5" to="/">
                  <img src="../logo512.png" className="pl-5 pr-5" alt="" />
                </Link>
              </li>
              <li className="nav-item mbhidden pt-1 pb-1  ">
                <Link className="nav-link pl-1 pr-1" to="/">
              ...
              <li className="nav-item pt-1 pb-1 active">
                <Link className="nav-link pl-1 pr-1" to="/hindi">
                  Hindi
                </Link>
              </li>
            </ul>
            <img className='tophead_img2 mbhidden' alt="" src="../City Samosa1.png"></img>
          </div>
        </div>
      </nav>
